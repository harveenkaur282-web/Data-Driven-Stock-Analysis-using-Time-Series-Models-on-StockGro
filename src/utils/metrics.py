...
metrics.py
----------
Shared evaluation metrics used by all forecasting models.
  - RMSE
  - MAPE
...
def evaluate(
    ...
    """
    Compute all three metrics and return a summary dict.
    This is the standard interface all model pipelines call.
    """
    return {
        "Ticker":  ticker,
        "Model":   model_name,
